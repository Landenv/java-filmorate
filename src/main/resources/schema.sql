...
-- Создание таблицы отзывов (ДОЛЖНА БЫТЬ ПЕРВОЙ ИЗ НОВЫХ ТАБЛИЦ)
...
-- Создание таблицы лайков/дизлайков отзывов (ПОСЛЕ reviews)
...
-- Создание индексов для оптимизации запросов отзывов (ПОСЛЕ СОЗДАНИЯ ТАБЛИЦ)
